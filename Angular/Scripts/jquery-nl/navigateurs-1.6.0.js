...
if (navigator.appVersion.indexOf("Android 2") != -1) { operatingSystemName = "Android 2"; }
if (navigator.appVersion.indexOf("Android 2.0") != -1) { operatingSystemName = "Android 2.0"; }
...
if (navigator.appVersion.indexOf("Android 2.2") != -1) { operatingSystemName = "Android 2.2"; }
...
if (navigator.appVersion.indexOf("Android 2.3") != -1) { operatingSystemName = "Android 2.3"; }
...
if (navigator.appVersion.indexOf("Android 3") != -1) { operatingSystemName = "Android 3"; }
if (navigator.appVersion.indexOf("Android 3.0") != -1) { operatingSystemName = "Android 3.0"; }
...
if (navigator.appVersion.indexOf("Android 4") != -1) { operatingSystemName = "Android 4"; }
if (navigator.appVersion.indexOf("Android 4.0") != -1) { operatingSystemName = "Android 4.0"; }
...
if (navigator.appVersion.indexOf("Android 4.1") != -1) { operatingSystemName = "Android 4.1"; }
...
if (navigator.appVersion.indexOf("Android 4.4") != -1) { operatingSystemName = "Android 4.4"; }
...
if (navigator.appVersion.indexOf("Android 5.0") != -1) { operatingSystemName = "Android 5.0"; }
...
if (navigator.appVersion.indexOf("Android 6") != -1) { operatingSystemName = "Android 6"; }
if (navigator.appVersion.indexOf("Android 6.0.1") != -1) { operatingSystemName = "Android 6.0.1"; }
if (navigator.appVersion.indexOf("Android N") != -1) { operatingSystemName = "Android N"; }
if (navigator.appVersion.indexOf("Android 7.0") != -1) { operatingSystemName = "Android 7.0"; }
...
if (navigator.appVersion.indexOf("Android 8") != -1) { operatingSystemName = "Android 8"; }
...
if (navigator.userAgent.indexOf("CriOS") != -1) { navName = 'Chrome/MAJ'; }
...
//cas particuliers que j'espère supprimer
//if ((operatingSystemName.indexOf('Windows 8') > -1) && ((navName == 'Chrome/MAJ') || (navName == 'Firefox/MAJ') || (navName.indexOf('Opera') != -1))) { touchNavigator = false; }
//if ((operatingSystemName.indexOf('Windows 8.1') > -1) && ((navName == 'Chrome/MAJ') || (navName == 'Firefox/MAJ') || (navName.indexOf('Opera') != -1))) { touchNavigator = false; }
//if ((operatingSystemName.indexOf('Windows 10') > -1) && ((navName == 'Chrome/MAJ') || (navName == 'Firefox/MAJ') || (navName.indexOf('Opera') != -1))) { touchNavigator = false; }
...
if (
    ...
    || (navName == 'Edge/12') || (navName == 'Edge/13') || (navName == 'Edge/14') || (navName == 'Edge/15')
    || (navName == 'Firefox/MAJ')
    || (navName == 'Chrome/MAJ')
    || (navName == 'iOSInside')
    || (navName == 'Safari/4') || (navName == 'Safari/5') || (navName == 'Safari/6') || (navName == 'Safari/7') || (navName == 'Safari/8') || (navName == 'Safari/9') || (navName == 'Safari/10') || (navName == 'Safari/11')
    || (navName == 'Opera/11') || (navName == 'Opera/12') || (navName == 'Opera/13') || (navName == 'Opera/14')
    || (navName == 'Opera/15') || (navName == 'Opera/16') || (navName == 'Opera/17') || (navName == 'Opera/18')
